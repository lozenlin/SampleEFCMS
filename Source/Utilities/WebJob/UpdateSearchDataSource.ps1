$conn = New-Object System.Data.SqlClient.SqlConnection("Server=tcp:YourAzureDB,1433;Initial Catalog=SampleEFCMS;Persist Security Info=False;User ID=YourAccount;Password=YourPassword;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;Application Name=UpdateSearchDataSource;")
